...
feature = np.array([g['ball'][0], g['ball'][1], g['platform_1P'][0], g['ball'][0] - pre['ball'][0], g['ball'][1] - pre['ball'][1], g['frame'], g['blocker'][0], g['blocker'][0] - pre['blocker'][0], g['ball_speed'][0], g['ball_speed'][1] ])
print(feature)
...
for i in range(2, len(game_info) - 1):
    g = game_info[i]
    pre = game_info[i-1]
    feature = np.vstack((feature, [g['ball'][0], g['ball'][1], g['platform_1P'][0],  g['ball'][0] - pre['ball'][0], g['ball'][1] - pre['ball'][1], g['frame'], g['blocker'][0], g['blocker'][0] - pre['blocker'][0],g['ball_speed'][0], g['ball_speed'][1]  ]))
...
grid = ensemble.RandomForestClassifier(n_estimators = 100)
grid.fit(x_train, y_train)
...
#儲存
file = open('forest_model_1P.pickle', 'wb')
